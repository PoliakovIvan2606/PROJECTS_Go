...
(
    ...
    CONSTRAINT positive_proce CHECK (price > 0),
...
VALUES ('купоны'), ('цифровые билеты');

-- INSERT INTO public.product (
--     name, description, image_id, price, currency_id, rating, category_id, specification, created_at, updated_at
-- ) VALUES (
--     'Sample Product', 
